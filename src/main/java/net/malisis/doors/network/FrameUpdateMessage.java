...
public class FrameUpdateMessage implements IMessageHandler<FrameUpdateMessage.Packet , IMessage> {
    ...
    public IMessage onMessage(FrameUpdateMessage.Packet message, MessageContext ctx) {
        ...
        BlockState blockState = new BlockState(message.blockX, message.blockY, message.blockZ, message.block, message.blockDamage);
    ...
    {
        FrameUpdateMessage.Packet packet = new FrameUpdateMessage.Packet(block, te.xCoord, te.yCoord, te.zCoord, damage);
