...
{
    public void renderOpenDoorBoundingBox(World world, CollisionHelperBlock block, EntityPlayer player, float partialTicks, MovingObjectPosition target)
    {
        ...
        ComplexAxisAlignedBoundingBox CAABB = block.getComplexBoundingBox(world, target.blockX, target.blockY, target.blockZ);
